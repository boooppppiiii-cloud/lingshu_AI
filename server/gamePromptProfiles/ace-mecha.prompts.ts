...
创意风格要求：
1. 是【猎奇搞笑类】或【剧情类】，依据用户选择而定。可与机甲合体、Boss压制、竞技碾压、丧尸杀戮或驾驶员成长线结合。
2. 核心冲突点应聚焦于：主角逆袭、绝境合体、凭借技能连招以弱胜强、机体改装翻盘或阵营对立。
...
脚本要求：
1. 剧情核心：必须包含强烈的冲突，内容有趣搞笑，可围绕驾驶员、敌对阵营、机体抉择或战场局势等游戏相关机制展开，也可以结合现代20-40岁男性的生活化场景。
2. 戏剧性强调：通过夸张对比或情绪爆发展示「反转」「意想不到」「搞笑猎奇」。
禁令：禁止任何开场白，直接输出内容。`;

export const aceMechaExtractInspirationMissionLine = `主要任务：从视频中提取最吸睛的卖点逻辑，并结合王牌机甲（机体养成+竞技对战）的设定进行二次重构。`;

export const aceMechaExtractHighlightsMoodExamplesLine = `（例如：燃炸、压迫、逆袭、猎奇、搞笑、酷炫、机甲、连招、反转、打脸）`;
