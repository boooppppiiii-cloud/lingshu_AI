  ...
  const profile = {
    ...
    products: { categories: '精华液、面膜、防晒乳', priceRange: 'US$1.80-8.50', moq: '500件', certifications: 'ISO 22716、GMPC', highlights: '低 MOQ、7天打样、OEM/ODM', items: [
      { sku: 'QA-SERUM-001', name: 'Mock 玻尿酸精华液', category: '精华液', priceRange: 'US$2.20-3.60', moq: '500件', certifications: 'ISO 22716', highlights: '补水、无香型、可定制包装',
        images: [{ name: 'qa-serum-product.jpg', type: 'image/jpeg', size: 120000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-serum-product/720/960' }],
        videos: [{ name: 'qa-serum-demo.mp4', type: 'video/mp4', size: 2500000, updatedAt: new Date().toISOString(), url: 'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' }],
        factoryImages: [{ name: 'qa-factory.jpg', type: 'image/jpeg', size: 130000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-factory/960/720' }],
        packagingImages: [{ name: 'qa-packaging.jpg', type: 'image/jpeg', size: 110000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-packaging/720/960' }],
        certificateImages: [{ name: 'qa-certificate.jpg', type: 'image/jpeg', size: 100000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-certificate/720/960' }],
      },
      { sku: 'QA-MASK-002', name: 'Mock 胶原面膜', category: '面膜', priceRange: 'US$1.80-2.80', moq: '1000件', certifications: 'GMPC', highlights: '独立包装、支持贴牌',
        images: [{ name: 'qa-mask-product.jpg', type: 'image/jpeg', size: 125000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-mask-product/720/960' }],
        sceneImages: [{ name: 'qa-mask-scene.jpg', type: 'image/jpeg', size: 140000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-mask-scene/720/960' }],
        brandAssets: [{ name: 'qa-brand-logo.jpg', type: 'image/jpeg', size: 90000, updatedAt: new Date().toISOString(), url: 'https://picsum.photos/seed/qa-brand-logo/720/720' }],
      },
    ] },
